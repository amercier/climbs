...
describe.skip('lib/middleware', () => {
  describe('requestMiddleware', () => {
    it('returns a function', () => expect(requestMiddleware()).toBeFunction());
  ...
  describe('userMiddleware', () => {
    it('returns a function', () => expect(userMiddleware()).toBeFunction());
  ...
  describe('headersMiddleware', () => {
    it('returns a function', () => expect(headersMiddleware()).toBeFunction());
  ...
  describe('sessionMiddleware', () => {
    it('returns a function', () => expect(sessionMiddleware()).toBeFunction());
